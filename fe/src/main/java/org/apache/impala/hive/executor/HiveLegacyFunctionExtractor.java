...
public class HiveLegacyFunctionExtractor {
  ...
  private static final Logger LOG = Logger.getLogger(
      HiveLegacyFunctionExtractor.class);
  ...
  public ScalarFunction extract(Function function, Method method) {
    ...
    ScalarFunction fn = new ScalarFunction(
        new FunctionName(function.getDbName(), function.getFunctionName()),
        fnArgsList,
  ...
  private ScalarType resolveParameterType(Class<?> param)
      throws ImpalaException {
    return resolveType(param, type ->
        "Param type " + type + " not supported");
  }

  private ScalarType resolveReturnType(Class<?> returnType)
      throws ImpalaException {
    return resolveType(returnType, type ->
        "Return type " + type + " not supported");
  }

  protected ScalarType resolveType(Class<?> type,
      java.util.function.Function<JavaUdfDataType, String> errorHandler)
      throws ImpalaException {
