...
public class IcebergPartitionExpr extends Expr {
  ...
  private final IcebergTable table_;

  public IcebergPartitionExpr(SlotRef slotRef, IcebergTable table) {
    slotRef_ = slotRef;
    transform_ = new IcebergPartitionTransform(TIcebergPartitionTransformType.IDENTITY);
    table_ = table;
  }
  ...
  public IcebergPartitionExpr(FunctionCallExpr callExpr, IcebergTable table)
  ...
  protected void analyzeImpl(Analyzer analyzer) throws AnalysisException {
    ...
    List<PartitionField> partitionFields =
        table_.getIcebergApiTable().spec().getFieldsBySourceId(
  ...
  @Override
  public Expr clone() {
    return new IcebergPartitionExpr(transform_, slotRef_, table_);
  }
}
