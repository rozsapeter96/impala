...
public class IcebergUtil {
  ...
  public static IcebergPartitionTransform getPartitionTransform(PartitionField field,
      Map<String, Integer> transformParams) throws AnalysisException {
  ...
  public static IcebergPartitionTransform getPartitionTransform(
      String transformType, Integer transformParam) throws AnalysisException {
  ...
  public static TIcebergPartitionTransformType getPartitionTransformType(
      String transformType) throws AnalysisException {
   ...
   */
  public static Optional<Integer> getDateTransformValue(
      TIcebergPartitionTransformType transformType, String stringValue) {
    try {
      switch (transformType) {
        case YEAR: return Optional.of(parseYearToTransformYear(stringValue));
        case MONTH: return Optional.of(parseMonthToTransformMonth(stringValue));
        case DAY: return Optional.ofNullable(parseDayToTransformMonth(stringValue));
        case HOUR: return Optional.ofNullable(parseHourToTransformHour(stringValue));
      }
  ...
  public static boolean isDateTransformType(
      TIcebergPartitionTransformType transformType) {
